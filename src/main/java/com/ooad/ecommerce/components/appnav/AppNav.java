package com.ooad.ecommerce.components.appnav;
 ...
 *
 * <p>Items can be added using {@link #addItem(AppNavItem)} and hierarchy can be created by adding
 * {@link AppNavItem} instances to other {@link AppNavItem} instances.
 */
...
public class AppNav extends Component implements HasSize, HasStyle {
   ...
   *
   * <p>If the given menu item is not a child of this menu, does nothing.
   *
   ...
   *
   * <p>This can help the end user to distinguish groups of navigation items. The label is also
   ...
   *
   * <p>NOTE: The navigation has to have a label for it to be collapsible.
   *
