 ...
 *
 * <p>Can contain a label and/or an icon and links to a given {@code path}.
 */
...
public class AppNavItem extends Component {
   ...
   *
   * <p>If the given menu item is not a child of this menu item, does nothing.
   *
   ...
   *
   * <p>The label is also available for screen rader users.
   *
   ...
   *
   * <p>Can also be used to set a custom component to be shown in front of the label.
   *
